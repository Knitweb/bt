...
from bt.actors import AGENT, PERSON, VOTEBANK_DAO, Actor
from bt.market import BtMarket
from bt.models import SELL, SignedOrder
from bt.p2p import Envelope
from bt.trust import Attestation, SignedAttestation

from .conftest import make_order


def add_trust(market: BtMarket, auditor, subject: str, score: int, now: int) -> None:
